...
# Generate the list of components to be fed to the modules
rec_to_bid_monomers = [L, R, DISC, flip, C8, BAR, Bid]
pore_to_parp_monomers = [MitoP, CytoC, Smac, Apaf, Apop, C3, C6, C8, C9, PARP, XIAP]

# Get the earm_1_0 parameters and modules 
import earm_1_0parms
import earm_1_0modules

# Generate the Receptor to Bid section from the EARM 1.0 module
earm_1_0modules.rec_to_bid(model, rec_to_bid_monomers)
...
earm_1_0modules.pore_to_parp(model, pore_to_parp_monomers)

...
parameter_dict = {
    ...
    'BID_trans':  [ Parameter('kbidCbidMf', 21.6709923373),
                    Parameter('kbidCbidMr', 1.9505637217e-05)],
    ...
    'BID_BAX_BAK_inh':[[Parameter('kbidbcl2f', 1.22751916712e-06),
                        Parameter('kbidbcl2r', 0.001718572955)],
    ...
    # Bid cleavage by C8
    'C8_BID':     [ Parameter('kc8bidf', 1.05534890325e-07),
                    Parameter('kc8bidr', 0.00322851890004),
                    Parameter('kc8bidc', 0.207110041092)],

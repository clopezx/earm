...
parameter_dict = {
    ...
    'BIDm_BAX':   [ Parameter('kbidmbaxf', 1.0e-07),
                    ...
                    Parameter('kbidmbaxc', 1.0    )],
    # Bak activation via Bid ***CHECK VALUES
    'BIDt_BAK':   [ Parameter('kbidtbakf', 1.0e-07),
                    Parameter('kbidtbakr', 1.0e-03),
                    Parameter('kbidtbakc', 1.0    )],
    #Bax pore assembly
    ...
    'DISC_C8':    [ Parameter('kdiscc8f', 1.0e-6),   
                    Parameter('kdiscc8r', 1.0e-3),
                    Parameter('kdiscc8c', 1.0   )],
    # Bid cleavage by C8
    'C8_BID':     [ Parameter('kc8bidf', 1.0e-6),
                    Parameter('kc8bidr', 1.0e-3),
                    Parameter('kc8bidc', 1.0   )],
    # DISC inhibition by FLIP
    'DISC_FLIP':  [ Parameter('kflipdiscf', 1.0e-6), 
                    Parameter('kflipdiscr', 1.0e-3)],
    # C8 inhibition by BAR
    'BAR_C8':     [ Parameter('kbarc8f', 1.0e-6), 
                    Parameter('kbarc8r', 1.0e-3)],
